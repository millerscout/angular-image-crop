      ...
      return {
        ...
        link: function (scope, element, attributes) {
          ...
          $img.onload = function() {
			...
			maxZoomedInLevel = ($canvas.height - 100) / imgHeight;
